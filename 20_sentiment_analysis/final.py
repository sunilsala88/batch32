...
event_dates_data = pd.read_csv('/Users/new algo trading/batch32/20_sentiment_analysis/aapl_event.csv')
...
stock_prices_data = pd.read_csv('/Users/new algo trading/batch32/20_sentiment_analysis/AAPL_history.csv', index_col=0)
...
daily_sentiment_scores = pd.read_csv('/Users/new algo trading/batch32/20_sentiment_analysis/daily_sentiment_scores_2016_jan_2023_sep.csv', index_col=0)
